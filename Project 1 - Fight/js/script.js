...
(function(){ //This is the beginning of the main function being executed
    ...
    function fight(){ //Beginning of function coding
        ...
        { //Beginning curly bracket of code statement
            ...
            var minDamage1 = player1Damage * .5; //Damage variable for fighter #1, multiplying damage by .5
            var minDamage2 = player2Damage * .5; //Damage variable for fighter #2, multiplying damage by .5
            var f1 = Math.floor(Math.random()*(player1Damage-minDamage1)+minDamage1); //Coded variable to randomly generate a damage result
            var f2 = Math.floor(Math.random()*(player2Damage-minDamage2)+minDamage2); //Coded variable to randomly generate a damage result
            ...
            { //beginning of else
                round++; //Round 2
                alert(playerOneName+":"+playerOneHealth+"  *ROUND "+round+" OVER"+"*  "+playerTwoName+":"+playerTwoHealth); //Console alerting that the round is over and displaying remaining health of each fighter
